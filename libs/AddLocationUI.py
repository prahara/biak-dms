...
# Form implementation generated from reading ui file 'UI/AddLocation.ui'
#
# Created: Sat Jan 18 13:02:44 2014
...
class Ui_AddLocation(object):
    def setupUi(self, AddLocation):
        ...
        AddLocation.setWindowModality(QtCore.Qt.NonModal)
        AddLocation.resize(410, 250)
        AddLocation.setMinimumSize(QtCore.QSize(410, 250))
        AddLocation.setMaximumSize(QtCore.QSize(410, 250))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/toolbar/location-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        AddLocation.setWindowIcon(icon)
        self.verticalLayoutWidget_6 = QtGui.QWidget(AddLocation)
        ...
        self.horizontalLayoutWidget = QtGui.QWidget(AddLocation)
        ...
        self.GB1 = QtGui.QGroupBox(AddLocation)
        ...
        self.horizontalLayoutWidget_2 = QtGui.QWidget(AddLocation)
        ...
        AddLocation.setTabOrder(self.lineEdit0loc_id, self.textEdit0loc_title)
        AddLocation.setTabOrder(self.textEdit0loc_title, self.pushButtonAddMore)
        AddLocation.setTabOrder(self.pushButtonAddMore, self.pushButtonCommitAll)
        AddLocation.setTabOrder(self.pushButtonCommitAll, self.lineEditRecordNo)
        AddLocation.setTabOrder(self.lineEditRecordNo, self.pushButtonFirst)
        AddLocation.setTabOrder(self.pushButtonFirst, self.pushButtonPrev)
        AddLocation.setTabOrder(self.pushButtonPrev, self.pushButtonNext)
        AddLocation.setTabOrder(self.pushButtonNext, self.pushButtonLast)

    def retranslateUi(self, AddLocation):
        AddLocation.setWindowTitle(QtGui.QApplication.translate("AddLocation", "Add Location", None, QtGui.QApplication.UnicodeUTF8))
        self.LblFolderID.setText(QtGui.QApplication.translate("AddLocation", "&Location ID", None, QtGui.QApplication.UnicodeUTF8))
        self.LblTitle.setText(QtGui.QApplication.translate("AddLocation", "&Title", None, QtGui.QApplication.UnicodeUTF8))
        self.LblTotalRecords.setText(QtGui.QApplication.translate("AddLocation", "0 record(s)", None, QtGui.QApplication.UnicodeUTF8))
        self.GB1.setTitle(QtGui.QApplication.translate("AddLocation", "Records Navigation", None, QtGui.QApplication.UnicodeUTF8))
        self.LblRecNo.setText(QtGui.QApplication.translate("AddLocation", "Rec #", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButtonAddMore.setText(QtGui.QApplication.translate("AddLocation", "&Save && Add More", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButtonCommitAll.setText(QtGui.QApplication.translate("AddLocation", "&Commit All", None, QtGui.QApplication.UnicodeUTF8))
