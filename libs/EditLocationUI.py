...
# Form implementation generated from reading ui file 'UI/EditLocation.ui'
#
# Created: Sat Jan 18 13:03:15 2014
...
class Ui_EditLocation(object):
    def setupUi(self, EditLocation):
        EditLocation.setObjectName("EditLocation")
        EditLocation.setWindowModality(QtCore.Qt.NonModal)
        EditLocation.resize(410, 250)
        EditLocation.setMinimumSize(QtCore.QSize(410, 250))
        EditLocation.setMaximumSize(QtCore.QSize(410, 250))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/toolbar/location-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        EditLocation.setWindowIcon(icon)
        self.verticalLayoutWidget_6 = QtGui.QWidget(EditLocation)
        ...
        self.lineEdit0loc_id = QtGui.QLineEdit(self.verticalLayoutWidget_6)
        ...
        self.VL1111.addWidget(self.lineEdit0loc_id)
        self.textEdit0loc_title = QtGui.QTextEdit(self.verticalLayoutWidget_6)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.textEdit0loc_title.setFont(font)
        self.textEdit0loc_title.setObjectName("textEdit0loc_title")
        self.VL1111.addWidget(self.textEdit0loc_title)
        self.HL111.addLayout(self.VL1111)
        self.HL110.addLayout(self.HL111)
        self.VL100.addLayout(self.HL110)
        self.horizontalLayoutWidget = QtGui.QWidget(EditLocation)
        ...
        self.GB1 = QtGui.QGroupBox(EditLocation)
        ...
        self.horizontalLayoutWidget_2 = QtGui.QWidget(EditLocation)
        ...
        self.LblFolderID.setBuddy(self.lineEdit0loc_id)
        self.LblTitle.setBuddy(self.textEdit0loc_title)
        self.LblRecNo.setBuddy(self.lineEditRecordNo)

        self.retranslateUi(EditLocation)
        QtCore.QMetaObject.connectSlotsByName(EditLocation)
        EditLocation.setTabOrder(self.lineEdit0loc_id, self.textEdit0loc_title)
        EditLocation.setTabOrder(self.textEdit0loc_title, self.pushButtonAddMore)
        EditLocation.setTabOrder(self.pushButtonAddMore, self.pushButtonCommitAll)
        EditLocation.setTabOrder(self.pushButtonCommitAll, self.lineEditRecordNo)
        EditLocation.setTabOrder(self.lineEditRecordNo, self.pushButtonFirst)
        EditLocation.setTabOrder(self.pushButtonFirst, self.pushButtonPrev)
        EditLocation.setTabOrder(self.pushButtonPrev, self.pushButtonNext)
        EditLocation.setTabOrder(self.pushButtonNext, self.pushButtonLast)

    def retranslateUi(self, EditLocation):
        EditLocation.setWindowTitle(QtGui.QApplication.translate("EditLocation", "Edit Location", None, QtGui.QApplication.UnicodeUTF8))
        self.LblFolderID.setText(QtGui.QApplication.translate("EditLocation", "&Location ID", None, QtGui.QApplication.UnicodeUTF8))
        self.LblTitle.setText(QtGui.QApplication.translate("EditLocation", "&Title", None, QtGui.QApplication.UnicodeUTF8))
        self.LblTotalRecords.setText(QtGui.QApplication.translate("EditLocation", "0 record(s)", None, QtGui.QApplication.UnicodeUTF8))
        self.GB1.setTitle(QtGui.QApplication.translate("EditLocation", "Records Navigation", None, QtGui.QApplication.UnicodeUTF8))
        self.LblRecNo.setText(QtGui.QApplication.translate("EditLocation", "Rec #", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButtonAddMore.setText(QtGui.QApplication.translate("EditLocation", "&Save && Edit Next", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButtonCommitAll.setText(QtGui.QApplication.translate("EditLocation", "&Commit All", None, QtGui.QApplication.UnicodeUTF8))
