...
from libs.AddFolderUI import Ui_AddFolder
import sys
from lib import *

__version__ = '0.0.1'

class AddFolder(QWidget, Ui_AddFolder):
    ...
    def decorUpdate(self):
        self.lineEdit0folder_id.clear()
        self.textEdit0folder_title.clear()
        self.lineEdit0folder_shelf_id.clear()
        self.lineEdit0folder_loc_id.clear()
        self.lineEditRecordNo.setText(str(self.curRecord))
        self.LblTotalRecords.setText("%s record(s)" % self.totalRecord)
        self.textEdit0folder_title.setTabChangesFocus(True)
        self.lineEdit0folder_id.setFocus()
