...
# Form implementation generated from reading ui file 'UI/EditFolder.ui'
#
# Created: Wed Jan 15 23:29:03 2014
...
class Ui_EditFolder(object):
    def setupUi(self, EditFolder):
        EditFolder.setObjectName("EditFolder")
        EditFolder.setWindowModality(QtCore.Qt.NonModal)
        EditFolder.resize(410, 250)
        EditFolder.setMinimumSize(QtCore.QSize(410, 250))
        EditFolder.setMaximumSize(QtCore.QSize(410, 250))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/toolbar/folder-new.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        EditFolder.setWindowIcon(icon)
        self.verticalLayoutWidget_6 = QtGui.QWidget(EditFolder)
        ...
        self.horizontalLayoutWidget = QtGui.QWidget(EditFolder)
        ...
        self.GB1 = QtGui.QGroupBox(EditFolder)
        ...
        self.horizontalLayoutWidget_2 = QtGui.QWidget(EditFolder)
        ...
        self.retranslateUi(EditFolder)
        QtCore.QMetaObject.connectSlotsByName(EditFolder)
        EditFolder.setTabOrder(self.lineEdit0folder_id, self.textEdit0folder_title)
        EditFolder.setTabOrder(self.textEdit0folder_title, self.lineEdit0folder_shelf_id)
        EditFolder.setTabOrder(self.lineEdit0folder_shelf_id, self.lineEdit0folder_loc_id)
        EditFolder.setTabOrder(self.lineEdit0folder_loc_id, self.pushButtonAddMore)
        EditFolder.setTabOrder(self.pushButtonAddMore, self.pushButtonCommitAll)
        EditFolder.setTabOrder(self.pushButtonCommitAll, self.lineEditRecordNo)
        EditFolder.setTabOrder(self.lineEditRecordNo, self.pushButtonFirst)
        EditFolder.setTabOrder(self.pushButtonFirst, self.pushButtonPrev)
        EditFolder.setTabOrder(self.pushButtonPrev, self.pushButtonNext)
        EditFolder.setTabOrder(self.pushButtonNext, self.pushButtonLast)

    def retranslateUi(self, EditFolder):
        EditFolder.setWindowTitle(QtGui.QApplication.translate("EditFolder", "Edit Folder", None, QtGui.QApplication.UnicodeUTF8))
        self.LblFolderID.setText(QtGui.QApplication.translate("EditFolder", "&Folder ID", None, QtGui.QApplication.UnicodeUTF8))
        self.LblTitle.setText(QtGui.QApplication.translate("EditFolder", "&Title", None, QtGui.QApplication.UnicodeUTF8))
        self.LblEndDate_2.setText(QtGui.QApplication.translate("EditFolder", "&Shelf ID", None, QtGui.QApplication.UnicodeUTF8))
        self.LblStartDate_2.setText(QtGui.QApplication.translate("EditFolder", "&Location ID", None, QtGui.QApplication.UnicodeUTF8))
        self.LblTotalRecords.setText(QtGui.QApplication.translate("EditFolder", "0 record(s)", None, QtGui.QApplication.UnicodeUTF8))
        self.GB1.setTitle(QtGui.QApplication.translate("EditFolder", "Records Navigation", None, QtGui.QApplication.UnicodeUTF8))
        self.LblRecNo.setText(QtGui.QApplication.translate("EditFolder", "Rec #", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButtonAddMore.setText(QtGui.QApplication.translate("EditFolder", "&Save && Edit Next", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButtonCommitAll.setText(QtGui.QApplication.translate("EditFolder", "&Commit Changes", None, QtGui.QApplication.UnicodeUTF8))
